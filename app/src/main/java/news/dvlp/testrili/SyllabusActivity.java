...
public class SyllabusActivity extends AppCompatActivity {
    ...
    * */
    ...
    private void initMarkData() {
        ...
        markData.put("2018-8-13", "1");
        markData.put("2018-8-16", "2");
        markData.put("2018-8-15", "0");
        markData.put("2018-8-14", "3");
        markData.put("2018-9-20", "3");
        markData.put("2018-10-20", "3");
    ...
    private void refreshClickDate(CalendarDate date) {
        //点击初始化数据
        HashMap<String, String> markData=  Utils.loadMarkData();
        currentDate = date;
